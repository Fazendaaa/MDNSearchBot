...
bot.on('inline_query', ({ i18n, answerInlineQuery, inlineQuery }) => __awaiter(this, void 0, void 0, function* () {
    ...
    const fetched = yield fetch_1.fetchMDN({ message, translate: i18n, locale: i18n.locale(), page: offset });
    const nextOffset = (1 !== fetched.length) ? offset : null;
    answerInlineQuery(parse_1.toInline(fetched), { next_offset: nextOffset });
}));
